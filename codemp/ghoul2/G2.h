...
#define BONE_ANIM_OVERRIDE_LOOP_REVERSE		0x0020
#define BONE_ANIM_OVERRIDE_FREEZE			( 0x0040 + BONE_ANIM_OVERRIDE )
#define BONE_ANIM_BLEND						0x0080
#define BONE_ANIM_TOTAL						( BONE_ANIM_OVERRIDE | BONE_ANIM_OVERRIDE_LOOP | BONE_ANIM_OVERRIDE_LOOP_REVERSE | BONE_ANIM_OVERRIDE_FREEZE | BONE_ANIM_BLEND)
