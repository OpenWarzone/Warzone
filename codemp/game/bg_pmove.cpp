...
void Pmove(pmove_t *pmove) {
	...
	// Make sure that saberAnimLevelBase is correct, cgame ONLY has saberDrawAnimLevel, but it happens to contain what we need...
	pmove->ps->fd.saberAnimLevelBase = pmove->ps->fd.saberDrawAnimLevel;
