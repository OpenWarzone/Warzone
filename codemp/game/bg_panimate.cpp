...
{//racc - is this a move where the player spins?
	...
	case BOTH_SABERBLOCK_L:
	case BOTH_SABERBLOCK_BL:
	case BOTH_SABERBLOCK_BR:
	case BOTH_SABERBLOCK_R:
	case BOTH_SABERBLOCK_TR:
	case BOTH_SABERBLOCK_T:

	case BOTH_SABERBLOCK_FL1:
	case BOTH_SABERBLOCK_FL2:
	case BOTH_SABERBLOCK_FL3:
	case BOTH_SABERBLOCK_FL4:
	case BOTH_SABERBLOCK_FL5:

	case BOTH_SABERBLOCK_FR1:
	case BOTH_SABERBLOCK_FR2:
	case BOTH_SABERBLOCK_FR3:
	case BOTH_SABERBLOCK_FR4:
	case BOTH_SABERBLOCK_FR5:

	case BOTH_SABERBLOCK_F1:
	case BOTH_SABERBLOCK_F2:
	case BOTH_SABERBLOCK_F3:
	case BOTH_SABERBLOCK_F4:
	case BOTH_SABERBLOCK_F5:

	case BOTH_SABERBLOCK_B1:
	case BOTH_SABERBLOCK_B2:
	case BOTH_SABERBLOCK_B3:
	case BOTH_SABERBLOCK_B4:
	case BOTH_SABERBLOCK_B5:

	case BOTH_SABERBLOCK_BL1:
	case BOTH_SABERBLOCK_BL2:
	case BOTH_SABERBLOCK_BL3:
	case BOTH_SABERBLOCK_BL4:
	case BOTH_SABERBLOCK_BL5:

	case BOTH_SABERBLOCK_BR1:
	case BOTH_SABERBLOCK_BR2:
	case BOTH_SABERBLOCK_BR3:
	case BOTH_SABERBLOCK_BR4:
	case BOTH_SABERBLOCK_BR5:

	case BOTH_CC_SABERBLOCK_FL1:
	case BOTH_CC_SABERBLOCK_FL2:
	case BOTH_CC_SABERBLOCK_FL3:
	case BOTH_CC_SABERBLOCK_FL4:
	case BOTH_CC_SABERBLOCK_FL5:

	case BOTH_CC_SABERBLOCK_FR1:
	case BOTH_CC_SABERBLOCK_FR2:
	case BOTH_CC_SABERBLOCK_FR3:
	case BOTH_CC_SABERBLOCK_FR4:
	case BOTH_CC_SABERBLOCK_FR5:

	case BOTH_CC_SABERBLOCK_F1:
	case BOTH_CC_SABERBLOCK_F2:
	case BOTH_CC_SABERBLOCK_F3:
	case BOTH_CC_SABERBLOCK_F4:
	case BOTH_CC_SABERBLOCK_F5:

	case BOTH_CC_SABERBLOCK_B1:
	case BOTH_CC_SABERBLOCK_B2:
	case BOTH_CC_SABERBLOCK_B3:
	case BOTH_CC_SABERBLOCK_B4:
	case BOTH_CC_SABERBLOCK_B5:

	case BOTH_CC_SABERBLOCK_BL1:
	case BOTH_CC_SABERBLOCK_BL2:
	case BOTH_CC_SABERBLOCK_BL3:
	case BOTH_CC_SABERBLOCK_BL4:
	case BOTH_CC_SABERBLOCK_BL5:

	case BOTH_CC_SABERBLOCK_BR1:
	case BOTH_CC_SABERBLOCK_BR2:
	case BOTH_CC_SABERBLOCK_BR3:
	case BOTH_CC_SABERBLOCK_BR4:
	case BOTH_CC_SABERBLOCK_BR5:
		return qtrue;
		break;
	}
	return qfalse;
