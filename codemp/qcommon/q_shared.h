...
//#define __DEBUG_SABER_STYLES__					// Enable access to all saber styles from all saber types (for testing)...
//#define __ALL_SABER_STYLES__						// Enable access to all normal JKA saber stances...
...
typedef enum {
	...
	CHAN_SABER,//## %s !!"W:\game\base\!!sound\*.wav;*.mp3" # added for saber specific sounds
	CHAN_SABERLOCAL,//## %s !!"W:\game\base\!!sound\*.wav;*.mp3" # added for saber specific sounds
	...
	CHAN_CULLRANGE_8192,	//## %s !!"W:\game\base\!!sound\*.wav;*.mp3" # Added for longer range culling options...
	CHAN_CULLRANGE_16384,	//## %s !!"W:\game\base\!!sound\*.wav;*.mp3" # Added for longer range culling options...
	CHAN_CULLRANGE_32768,	//## %s !!"W:\game\base\!!sound\*.wav;*.mp3" # Added for longer range culling options...
	CHAN_CULLRANGE_65536,	//## %s !!"W:\game\base\!!sound\*.wav;*.mp3" # Added for longer range culling options...
	CHAN_CULLRANGE_131072,	//## %s !!"W:\game\base\!!sound\*.wav;*.mp3" # Added for longer range culling options...
	CHAN_AMBIENT,//## %s !!"W:\game\base\!!sound\*.wav;*.mp3" # added for ambient sounds
	CHAN_AMBIENT_EFX,//## %s !!"W:\game\base\!!sound\*.wav;*.mp3" # added for ambient sounds from efx system
