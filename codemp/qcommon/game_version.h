...
#if defined(_DEBUG)
	#define	JK_VERSION		"^5(^7debug^5)^3Star Wars Warzone: ^5v"VERSION_STRING_DOTTED
	#define JK_VERSION_OLD	"^5(^7debug^5)^3JAmp: ^5v"VERSION_STRING_DOTTED
#else
	#define	JK_VERSION		"^3Star Wars Warzone^5: v"VERSION_STRING_DOTTED
	#define JK_VERSION_OLD	"^3JAmp: ^5v"VERSION_STRING_DOTTED
#endif
