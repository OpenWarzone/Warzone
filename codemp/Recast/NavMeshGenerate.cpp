...
void NavMeshGenerate::handleSettings()
{
...
void NavMeshGenerate::handleTools()
{
#if 0
...
void NavMeshGenerate::handleDebugMode()
{
#if 0
...
void NavMeshGenerate::handleRender()
{
#if 0
...
void NavMeshGenerate::handleRenderOverlay(double* proj, double* model, int* view)
{
#if 0
	if (m_tool)
...
void NavMeshGenerate::handleMeshChanged(class InputGeom* geom)
{
...
bool NavMeshGenerate::handleBuild()
{
	if (!m_geom || !m_geom->getMesh())
	{
	...
	m_ctx->log(RC_LOG_ERROR, "buildNavigation: bmin %f %f %f. bmax %f %f %f. nverts %d. ntris %d.", bmin[0], bmin[1], bmin[2], bmax[0], bmax[1], bmax[2], nverts, ntris);
