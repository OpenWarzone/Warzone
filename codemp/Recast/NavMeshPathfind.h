...
#ifndef NavMeshPathfind_H
#define NavMeshPathfind_H
...
class NavMeshPathfind : public SampleTool
{
	Sample* m_sample;
...
public:
	...
	virtual void reset();
	virtual void handleAction(int mode, int straightPathOptions);
