...
float		STANDARD_SPLATMAP_STEEPANGLE = 46.0;
float		STANDARD_SPLATMAP_STEEPPCURVE = 0.75;
float		STANDARD_SPLATMAP_STEEPMINIMUM = 0.2;
float		STANDARD_SPLATMAP_STEEPMAXIMUM = 0.7;
...
float		GRASS_PATCH_DENSITY = 1.0;
float		GRASS_PATCH_SCALE = 1.0;
vec2_t		GRASS_PATCH_OFFSET = { { 0 } };
...
float		GRASS2_PATCH_DENSITY = 1.0;
float		GRASS2_PATCH_SCALE = 1.0;
vec2_t		GRASS2_PATCH_OFFSET = { { 0 } };
...
float		GRASS3_PATCH_DENSITY = 1.0;
float		GRASS3_PATCH_SCALE = 1.0;
vec2_t		GRASS3_PATCH_OFFSET = { { 0 } };
...
float		GRASS4_PATCH_DENSITY = 1.0;
float		GRASS4_PATCH_SCALE = 1.0;
vec2_t		GRASS4_PATCH_OFFSET = { { 0 } };
...
void MAPPING_LoadMapInfo(void)
{
	...
	VectorClear(TOWN_ORIGIN);
	TOWN_RADIUS = 0.0;
	TOWN_FORCEFIELD_ALPHAMULT = 1.0;
	...
	TOWN_FORCEFIELD_ORIGIN[2] = atof(IniRead(mapname, "TOWN", "TOWN_FORCEFIELD_ORIGIN_Z", "999999.9"));

	TOWN_FORCEFIELD_RADIUS[0] = atof(IniRead(mapname, "TOWN", "TOWN_FORCEFIELD_RADIUS_X", "999999.9"));
	TOWN_FORCEFIELD_RADIUS[1] = atof(IniRead(mapname, "TOWN", "TOWN_FORCEFIELD_RADIUS_Y", "999999.9"));
	TOWN_FORCEFIELD_RADIUS[2] = atof(IniRead(mapname, "TOWN", "TOWN_FORCEFIELD_RADIUS_Z", "999999.9"));

	float maxTownRadius = max(TOWN_FORCEFIELD_RADIUS[0], TOWN_FORCEFIELD_RADIUS[1]);
	...
	if (TOWN_FORCEFIELD_ORIGIN[0] < 999990.0
		...
		&& maxTownRadius > 0.0)
	{
		VectorCopy(TOWN_FORCEFIELD_ORIGIN, TOWN_ORIGIN);
		TOWN_RADIUS = maxTownRadius * 0.5;
		TOWN_FORCEFIELD_ALPHAMULT = atof(IniRead(mapname, "TOWN", "TOWN_FORCEFIELD_ALPHAMULT", "1.0"));
	}
	...
	STANDARD_SPLATMAP_STEEPANGLE = atof(IniRead(mapname, "SPLATMAPS", "STANDARD_SPLATMAP_STEEPANGLE", "46.0"));
	STANDARD_SPLATMAP_STEEPPCURVE = atof(IniRead(mapname, "SPLATMAPS", "STANDARD_SPLATMAP_STEEPPCURVE", "0.75"));
	STANDARD_SPLATMAP_STEEPMINIMUM = Q_clamp(0.0, atof(IniRead(mapname, "SPLATMAPS", "STANDARD_SPLATMAP_STEEPMINIMUM", "0.2")), 1.0);
	STANDARD_SPLATMAP_STEEPMAXIMUM = Q_clamp(0.0, atof(IniRead(mapname, "SPLATMAPS", "STANDARD_SPLATMAP_STEEPMAXIMUM", "0.7")), 1.0);
	...
	if (FOG_POST_ENABLED)
	{
		FOG_LATE_FOG = (atoi(IniRead(mapname, "FOG", "FOG_LATE_FOG", "1")) > 0) ? qtrue : qfalse;
		...
		if (FOG_LINEAR_ENABLE)
		{
			...
			FOG_LINEAR_USE_POSITIONMAP = (atoi(IniRead(mapname, "FOG", "FOG_LINEAR_USE_POSITIONMAP", "1")) > 0) ? qtrue : qfalse;
			FOG_LINEAR_POSITIONMAP_MAX_RANGE = atof(IniRead(mapname, "FOG", "FOG_LINEAR_POSITIONMAP_MAX_RANGE", "65536.0"));
		}
	...
	if (GRASS_ENABLED)
	{
		...
		GRASS_PATCH_DENSITY = atof(IniRead(mapname, "GRASS", "GRASS_PATCH_DENSITY", "1.0"));
		GRASS_PATCH_SCALE = atof(IniRead(mapname, "GRASS", "GRASS_PATCH_SCALE", "1.0"));
		GRASS_PATCH_OFFSET[0] = atof(IniRead(mapname, "GRASS", "GRASS_PATCH_OFFSET_X", "0.0"));
		GRASS_PATCH_OFFSET[1] = atof(IniRead(mapname, "GRASS", "GRASS_PATCH_OFFSET_Y", "0.0"));
	...
	if (GRASS2_ENABLED)
	{
		...
		GRASS2_PATCH_DENSITY = atof(IniRead(mapname, "GRASS2", "GRASS_PATCH_DENSITY", "1.0"));
		GRASS2_PATCH_SCALE = atof(IniRead(mapname, "GRASS2", "GRASS_PATCH_SCALE", "1.0"));
		GRASS2_PATCH_OFFSET[0] = atof(IniRead(mapname, "GRASS2", "GRASS_PATCH_OFFSET_X", "1.0"));
		GRASS2_PATCH_OFFSET[1] = atof(IniRead(mapname, "GRASS2", "GRASS_PATCH_OFFSET_Y", "1.0"));
	...
	if (GRASS3_ENABLED)
	{
		...
		GRASS3_PATCH_DENSITY = atof(IniRead(mapname, "GRASS3", "GRASS_PATCH_DENSITY", "1.0"));
		GRASS3_PATCH_SCALE = atof(IniRead(mapname, "GRASS3", "GRASS_PATCH_SCALE", "1.0"));
		GRASS3_PATCH_OFFSET[0] = atof(IniRead(mapname, "GRASS3", "GRASS_PATCH_OFFSET_X", "2.0"));
		GRASS3_PATCH_OFFSET[1] = atof(IniRead(mapname, "GRASS3", "GRASS_PATCH_OFFSET_Y", "2.0"));
	...
	if (GRASS4_ENABLED)
	{
		...
		GRASS4_PATCH_DENSITY = atof(IniRead(mapname, "GRASS4", "GRASS_PATCH_DENSITY", "1.0"));
		GRASS4_PATCH_SCALE = atof(IniRead(mapname, "GRASS4", "GRASS_PATCH_SCALE", "1.0"));
		GRASS4_PATCH_OFFSET[0] = atof(IniRead(mapname, "GRASS4", "GRASS_PATCH_OFFSET_X", "3.0"));
		GRASS4_PATCH_OFFSET[1] = atof(IniRead(mapname, "GRASS4", "GRASS_PATCH_OFFSET_Y", "3.0"));
