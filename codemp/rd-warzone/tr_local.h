...
#define __HDR_POSTPROCESS_BUFFERS__				// Use 32 bit float buffers when doing post fx. Looks much better (lighting and brights) for little extra cost.
...
extern cvar_t	*r_mergePolysDebug;
...
typedef struct trGlobals_s {
	...
	shaderProgram_t fsrUpscaleShader;
	shaderProgram_t fsrSharpenShader;
