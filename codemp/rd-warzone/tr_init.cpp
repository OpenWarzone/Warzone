...
cvar_t	*r_realtimeDrawSort;
cvar_t	*r_mergePolysDebug;
cvar_t	*r_useLowP;
...
void R_Register( void )
{
	...
	r_fastShadows = ri->Cvar_Get("r_fastShadows", "0", CVAR_ARCHIVE);
	...
	r_realtimeDrawSort = ri->Cvar_Get("r_realtimeDrawSort", "1", CVAR_ARCHIVE);
	r_mergePolysDebug = ri->Cvar_Get("r_mergePolysDebug", "0", CVAR_ARCHIVE);
