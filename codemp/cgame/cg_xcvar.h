...
XCVAR_DEF(cg_showShieldBubble, "0", NULL, CVAR_ARCHIVE)
...
XCVAR_DEF(g_saberScriptedAnimations, "0", NULL, CVAR_SERVERINFO | CVAR_ARCHIVE)
...
XCVAR_DEF(inv_trashslot, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_moveslotstart, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_moveslotend, "-1", NULL, CVAR_NONE)

XCVAR_DEF(inv_equipment0, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_equipment1, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_equipment2, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_equipment3, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_equipment4, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_equipment5, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_equipment6, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_equipment7, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_equipment8, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_equipment9, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_equipment10, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_equipment11, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_equipment12, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_equipment13, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_equipment14, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_equipment15, "-1", NULL, CVAR_NONE)

XCVAR_DEF(inv_quickbar1, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_quickbar2, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_quickbar3, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_quickbar4, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_quickbar5, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_quickbar6, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_quickbar7, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_quickbar8, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_quickbar9, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_quickbar10, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_quickbar11, "-1", NULL, CVAR_NONE)
XCVAR_DEF(inv_quickbar12, "-1", NULL, CVAR_NONE)
#undef XCVAR_DEF