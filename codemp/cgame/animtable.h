...
stringID_table_t animTable [MAX_ANIMATIONS+1] =
{
	...
	ENUM2STRING(BOTH_P1_S1_B_),  //# Saber Back top Block
	//Saber knockaway
...
//[/SaberSys]
	...
	ENUM2STRING(BOTH_BURST),
	ENUM2STRING(BOTH_BURSTMISS),
	ENUM2STRING(BOTH_THROW1),
	ENUM2STRING(BOTH_THROWED1),
	ENUM2STRING(BOTH_THROW2),
	ENUM2STRING(BOTH_THROWED2),
	ENUM2STRING(BOTH_THROW),
	ENUM2STRING(BOTH_THROWEE),
	...
	ENUM2STRING(BOTH_SINGLE_STANCE),
	ENUM2STRING(BOTH_CC_STANCE),

	ENUM2STRING(BOTH_SINGLE_DEFENCE_SPIN),
	ENUM2STRING(BOTH_CC_DEFENCE_SPIN),

	ENUM2STRING(BOTH_SABERBLOCK_TL),
	ENUM2STRING(BOTH_SABERBLOCK_L),
	ENUM2STRING(BOTH_SABERBLOCK_BL),
	ENUM2STRING(BOTH_SABERBLOCK_BR),
	ENUM2STRING(BOTH_SABERBLOCK_R),
	ENUM2STRING(BOTH_SABERBLOCK_TR),
	ENUM2STRING(BOTH_SABERBLOCK_T),

	ENUM2STRING(BOTH_SABERBLOCK_FL1),
	ENUM2STRING(BOTH_SABERBLOCK_FL2),
	ENUM2STRING(BOTH_SABERBLOCK_FL3),
	ENUM2STRING(BOTH_SABERBLOCK_FL4),
	ENUM2STRING(BOTH_SABERBLOCK_FL5),

	ENUM2STRING(BOTH_SABERBLOCK_FR1),
	ENUM2STRING(BOTH_SABERBLOCK_FR2),
	ENUM2STRING(BOTH_SABERBLOCK_FR3),
	ENUM2STRING(BOTH_SABERBLOCK_FR4),
	ENUM2STRING(BOTH_SABERBLOCK_FR5),

	ENUM2STRING(BOTH_SABERBLOCK_F1),
	ENUM2STRING(BOTH_SABERBLOCK_F2),
	ENUM2STRING(BOTH_SABERBLOCK_F3),
	ENUM2STRING(BOTH_SABERBLOCK_F4),
	ENUM2STRING(BOTH_SABERBLOCK_F5),

	ENUM2STRING(BOTH_SABERBLOCK_B1),
	ENUM2STRING(BOTH_SABERBLOCK_B2),
	ENUM2STRING(BOTH_SABERBLOCK_B3),
	ENUM2STRING(BOTH_SABERBLOCK_B4),
	ENUM2STRING(BOTH_SABERBLOCK_B5),

	ENUM2STRING(BOTH_SABERBLOCK_BL1),
	ENUM2STRING(BOTH_SABERBLOCK_BL2),
	ENUM2STRING(BOTH_SABERBLOCK_BL3),
	ENUM2STRING(BOTH_SABERBLOCK_BL4),
	ENUM2STRING(BOTH_SABERBLOCK_BL5),

	ENUM2STRING(BOTH_SABERBLOCK_BR1),
	ENUM2STRING(BOTH_SABERBLOCK_BR2),
	ENUM2STRING(BOTH_SABERBLOCK_BR3),
	ENUM2STRING(BOTH_SABERBLOCK_BR4),
	ENUM2STRING(BOTH_SABERBLOCK_BR5),

	ENUM2STRING(BOTH_CC_SABERBLOCK_FL1),
	ENUM2STRING(BOTH_CC_SABERBLOCK_FL2),
	ENUM2STRING(BOTH_CC_SABERBLOCK_FL3),
	ENUM2STRING(BOTH_CC_SABERBLOCK_FL4),
	ENUM2STRING(BOTH_CC_SABERBLOCK_FL5),

	ENUM2STRING(BOTH_CC_SABERBLOCK_FR1),
	ENUM2STRING(BOTH_CC_SABERBLOCK_FR2),
	ENUM2STRING(BOTH_CC_SABERBLOCK_FR3),
	ENUM2STRING(BOTH_CC_SABERBLOCK_FR4),
	ENUM2STRING(BOTH_CC_SABERBLOCK_FR5),

	ENUM2STRING(BOTH_CC_SABERBLOCK_F1),
	ENUM2STRING(BOTH_CC_SABERBLOCK_F2),
	ENUM2STRING(BOTH_CC_SABERBLOCK_F3),
	ENUM2STRING(BOTH_CC_SABERBLOCK_F4),
	ENUM2STRING(BOTH_CC_SABERBLOCK_F5),

	ENUM2STRING(BOTH_CC_SABERBLOCK_B1),
	ENUM2STRING(BOTH_CC_SABERBLOCK_B2),
	ENUM2STRING(BOTH_CC_SABERBLOCK_B3),
	ENUM2STRING(BOTH_CC_SABERBLOCK_B4),
	ENUM2STRING(BOTH_CC_SABERBLOCK_B5),

	ENUM2STRING(BOTH_CC_SABERBLOCK_BL1),
	ENUM2STRING(BOTH_CC_SABERBLOCK_BL2),
	ENUM2STRING(BOTH_CC_SABERBLOCK_BL3),
	ENUM2STRING(BOTH_CC_SABERBLOCK_BL4),
	ENUM2STRING(BOTH_CC_SABERBLOCK_BL5),

	ENUM2STRING(BOTH_CC_SABERBLOCK_BR1),
	ENUM2STRING(BOTH_CC_SABERBLOCK_BR2),
	ENUM2STRING(BOTH_CC_SABERBLOCK_BR3),
	ENUM2STRING(BOTH_CC_SABERBLOCK_BR4),
	ENUM2STRING(BOTH_CC_SABERBLOCK_BR5),

	ENUM2STRING(PAIRED_ATTACKER01),
	ENUM2STRING(PAIRED_DEFENDER01),

	ENUM2STRING(BOTH_SABERATTACK_01),
	ENUM2STRING(BOTH_SABERATTACK_02),
	ENUM2STRING(BOTH_SABERATTACK_03),
	ENUM2STRING(BOTH_SABERATTACK_04),
	ENUM2STRING(BOTH_SABERATTACK_05),
	ENUM2STRING(BOTH_SABERATTACK_06),
	ENUM2STRING(BOTH_SABERATTACK_07),
	ENUM2STRING(BOTH_SABERATTACK_08),
	ENUM2STRING(BOTH_SABERATTACK_09),
	ENUM2STRING(BOTH_SABERATTACK_10),
	//[/NewANIM]
